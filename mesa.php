...
<body>
    ...
    <section class="join-community">
        <div class="container">
            <h2>What is MESA?</h2>
            <p>"MESA (Mechanical Engineering Student Association) is a dynamic student body committed 
                to enriching the academic and social journey of Mechanical Engineering students. 
                MESA orchestrates diverse initiatives, 
                fostering a vibrant community that prioritizes growth, 
                and student well-being within the department."</p>
                <?php session_start();
            ...
            <?php
               ...
               $admin = $_SESSION['user_role'] ;
                ...
                if ($admin === 'admin') :?>
            <a href="panelm.php" class="join-button">Manage Users</a>
            <?php endif; ?>
        </div>
    </section>
</section>
