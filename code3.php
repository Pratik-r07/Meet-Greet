...
if(isset($_POST['add_reply']))
{
    ...
    $query = "INSERT INTO comment_replies3 (user_id,comment_id,reply_msg) VALUES ('$user_id','$cmt_id','$reply')";
...
{
    $comments_query = "SELECT * FROM comments3";
...
if(isset($_POST["view_comment_data"]))
{
    ...
    $query = "SELECT * FROM comment_replies3 WHERE comment_id='$cmt_id' ";
    $query_run = mysqli_query($conn, $query);
...
if(isset($_POST['add_comment']))
{
    ...
    $comment_add_query = "INSERT INTO comments3 (user_id,msg) VALUES ('$user_id','$msg')";
